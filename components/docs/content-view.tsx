  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 text-xs font-mono text-zinc-500 dark:text-zinc-400">
        <span className="text-zinc-400 dark:text-zinc-500">Docs</span>
        <IconChevronRight className="w-3 h-3 text-zinc-400 dark:text-zinc-600" />
        <span className="px-2.5 py-0.5 rounded-full bg-zinc-100 dark:bg-white/[0.04] border border-zinc-200 dark:border-white/[0.06] text-zinc-700 dark:text-zinc-300">
          {section.category}
        </span>
        <IconChevronRight className="w-3 h-3 text-zinc-400 dark:text-zinc-600" />
        <span className="text-zinc-950 dark:text-white font-medium">{section.title}</span>
      </div>
      ...
      {section.requirements && section.requirements.length > 0 && (
        <section id="you-will-need" className="p-5 sm:p-6 rounded-2xl border border-zinc-200 dark:border-white/[0.08] bg-zinc-50/80 dark:bg-[#181818] space-y-3.5 shadow-sm transition-colors">
          <h2 className="text-sm font-semibold text-zinc-900 dark:text-white uppercase tracking-wider font-mono">
            Prerequisites & Requirements
          </h2>
          <ul className="space-y-2.5 text-[13.5px] text-zinc-700 dark:text-zinc-300">
            {section.requirements.map((req, i) => (
              <li key={i} className="flex items-start gap-2.5">
                <IconCircleCheck className="w-4 h-4 text-purple-600 dark:text-purple-400 shrink-0 mt-0.5" />
        ...
        <>
          ...
          <section id="supported-chains" className="space-y-4 pt-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5">
              <div className="p-5 rounded-2xl border border-zinc-200 dark:border-white/[0.08] bg-white dark:bg-[#181818] hover:border-purple-500/40 transition-all space-y-2 shadow-xs">
                <div className="flex items-center justify-between">
                  <h3 className="font-semibold text-sm text-zinc-900 dark:text-white">Solana</h3>
                  <span className="text-[10px] font-mono px-2 py-0.5 rounded-full bg-purple-500/10 dark:bg-purple-500/15 text-purple-600 dark:text-purple-300 border border-purple-500/20 dark:border-purple-500/30">Fast</span>
                </div>
              ...
              <div className="p-5 rounded-2xl border border-zinc-200 dark:border-white/[0.08] bg-white dark:bg-[#181818] hover:border-purple-500/40 transition-all space-y-2 shadow-xs">
                <div className="flex items-center justify-between">
                  <h3 className="font-semibold text-sm text-zinc-900 dark:text-white">BNB Chain</h3>
                  <span className="text-[10px] font-mono px-2 py-0.5 rounded-full bg-emerald-500/10 dark:bg-emerald-500/15 text-emerald-600 dark:text-emerald-300 border border-emerald-500/20 dark:border-emerald-500/30">Low Gas</span>
                </div>
                <p className="text-xs text-zinc-500 dark:text-zinc-400 leading-relaxed">
              ...
              <div className="p-5 rounded-2xl border border-zinc-200 dark:border-white/[0.08] bg-white dark:bg-[#181818] hover:border-purple-500/40 transition-all space-y-2 shadow-xs">
                <div className="flex items-center justify-between">
                  <h3 className="font-semibold text-sm text-zinc-900 dark:text-white">Robinhood Chain</h3>
                  <span className="text-[10px] font-mono px-2 py-0.5 rounded-full bg-cyan-500/10 dark:bg-cyan-500/15 text-cyan-600 dark:text-cyan-300 border border-cyan-500/20 dark:border-cyan-500/30">Pons</span>
                </div>
                <p className="text-xs text-zinc-500 dark:text-zinc-400 leading-relaxed">
          ...
          <section id="next-steps" className="space-y-3 pt-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
              <button
                ...
                className="p-5 rounded-2xl border border-zinc-200 dark:border-white/[0.08] hover:border-purple-500/50 bg-white dark:bg-[#181818] hover:bg-zinc-50 dark:hover:bg-[#1a1a1a] text-left transition-all cursor-pointer group shadow-xs"
              >
                <div className="flex items-center justify-between">
                  <div className="text-sm font-semibold text-zinc-900 dark:text-white group-hover:text-purple-600 dark:group-hover:text-purple-300 transition-colors">
                    Quickstart Guide
                  </div>
                  <IconArrowUpRight className="w-4 h-4 text-zinc-400 dark:text-zinc-500 group-hover:text-purple-600 dark:group-hover:text-purple-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all" />
                </div>
      ...
      {section.responseSnippet && (
        <section id="response-payload" className="space-y-3 pt-2">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs font-mono font-bold px-2.5 py-0.5 rounded-full bg-emerald-500/10 dark:bg-emerald-500/15 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20 dark:border-emerald-500/30">
      ...
      {section.tableData && (
        <section id="table-parameters" className="space-y-3 pt-2">
          ...
          <div className="overflow-x-auto rounded-2xl border border-zinc-200 dark:border-white/[0.08] bg-white dark:bg-[#181818] shadow-sm">
            <table className="w-full text-left text-[13px] border-collapse">
              <thead>
                <tr className="border-b border-zinc-200 dark:border-white/[0.08] bg-zinc-50 dark:bg-[#141414] text-zinc-600 dark:text-zinc-400">
                  ...
                  >
                    {row.map((col, colIdx) => (
                      <td
                        ...
                        className={`py-3 px-4 ${
                          colIdx === 0
                            ? "font-mono font-medium text-purple-600 dark:text-purple-300"
      ...
      {/* Footer Navigation */}
      <div className="pt-10 border-t border-zinc-200 dark:border-white/[0.08] flex items-center justify-between text-xs text-zinc-500 dark:text-zinc-400">
        <div>
